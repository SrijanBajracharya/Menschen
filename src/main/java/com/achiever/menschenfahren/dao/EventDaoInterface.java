...
public interface EventDaoInterface extends JpaRepository<Event, String> {
     ...
     *
     * @param alsoVoided
     *            Flag to check if the event is voided or not.
     ...
     *            Flag to check if the event is voided or not.
     * @param alsoPrivate
     *            Flag to check for event is private or not.
     * @return The event.
     */
    Optional<Event> findByIdAndVoidedAndIsPrivate(@Nonnull final String id, final boolean alsoVoided, final boolean alsoPrivate);

    /**
     * Finds list of events by voided and private flag.
     *
     * @param alsoVoided
     *            Filter for event to be voided or not.
     * @param alsoPrivate
     *            Filter for event to be private or not.
