...
public interface UserProfileRestControllerInterface {
	 ...
	 *
	 * @param request    The set of data to be saved.
	 * @param alsoVoided The flag to check if the profile is voided or not.
	 * @return The saved user profile
	 * @throws InvalidUserException Thrown if the user is invalid.
	 */
	 ...
	 *
	 * @param id The identifier of user profile
	 * @return The user profile.
	 * @throws ResourceNotFoundException Thrown if the userProfile cannot be found
	 *                                   for given id.
	 */
	...
	ResponseEntity<DataResponse<UserProfileDto>> getUserProfileById(
			@PathVariable(name = "id", required = true) @Nonnull final String id) throws ResourceNotFoundException;

	/**
	 * Updates the given Event.
	 *
	 * @param eventId The id of the event as part of the path.
	 * @param request The set of updated values.
	 * @return The updated event or an error code.
	 * @throws ResourceNotFoundException If the referenced Id wasn't found. Will be
	 *                                   returned as code 404.
	 */
	@Operation(description = "Updates an exisiting user profile.")
	@Parameters(value = {
			@Parameter(name = "request", description = "The fields as request body that can be changed during a basic edit operation"),
	 ...
	 *
	 * @param alsoVoided The flag for voided.
	 * @return
	 * @throws ResourceNotFoundException      If the user profile cannot be found.
	 * @throws MultipleResourceFoundException If multiple user profile is found.
	 */
	@Operation(description = "Get User profile by user id.")
	@Parameters(value = {
			@Parameter(name = CommonConstants.Params.USER_ID, description = "The id of the user as part of the path.") })
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "User profile found", content = {
	 ...
	 * Update a new avatar.
	 *
	 * @param avatar The picture to update.
	 * @param userId The id of the user.
	 * @return
	 */
	@Operation(description = "Upload a new avatar")
	@Parameters(value = {
			@Parameter(name = CommonConstants.Params.AVATAR, description = "The avatar file. Only image files are supported."),
	...
	ResponseEntity<String> updateUserPicture(
			@RequestParam(name = CommonConstants.Params.AVATAR) @Nonnull MultipartFile avatar);
